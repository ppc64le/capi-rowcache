...
public class CapiCacheProviderTest {
    ...
    static {
        ...
        if (System.getProperty("capi.devices") == null)
            System.setProperty("capi.devices", "/tmp/capi.log:0:1");
    ...
    public void testMemory() throws InterruptedException {
        ...
        for (int i = 0; i < numOfTests; ++i) {
            ...
            RowCacheKey rowCacheKey = new RowCacheKey(new MyKey("test", key), key.getBytes());
        ...
        for (int i = 0; i < numOfTests; ++i) {
            ...
            assertEquals(createValue(key, value).iterator().next(), ((CachedBTreePartition) cache.get(rowCacheKey)).iterator().next());
        }
